...
module.exports = function (opts) {
    ...
    function Package (name) {
        ...
        package.getContent = function (callback) {
            ...
            async.map(package.assets, function (asset, callback) {
                ...
                callback(content, package.digest);
            });
        };
    ...
    function send (obj, req, res, next) {
        ...
        res.getHeader('Last-Modified') || res.setHeader('Last-Modified', obj.lastModified.toUTCString());
        ...
        obj.getContent(function (content, digest) {
            if (digest) {
                res.getHeader('ETag') || res.setHeader('ETag', digest);
            }
