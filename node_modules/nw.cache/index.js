    ...
    cache.get = function (key, callback) {
        if (cache.trust && !trustedKeys[key]) {
            ...
            if (!cache.mtime) {
                ...
                async.parellel([function (callback) {
...
exports.create = function () {
    ...
    var backend = url.parse(opts.backend);
    var backendModule = require('./backends/'+backend.protocol.slice(0, -1));

    backendModule(backend, function (connection, prefix) {
        debugger;
        if (prefix) {
            prefixParts.unshift(prefix);
        }
