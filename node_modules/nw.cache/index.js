...
function Cache (connection, opts) {
    ...
    cache.set = function (key, value, expires, callback) {
        ...
        if (!cache.mtime) {
            connection.set(key, value, expires, callback);
        } else {
            async.parallel([function (callback) {
                connection.set(key, value, expires, function () {
                    callback(null);
                })
            }, function (callback) {
                connection.set(key+'.mtime', new Date().getTime(), expires, function () {
                    callback(null);
                })
            }], function () {
                callback();
